...
def simulate(ij, itraj, TrajFolder, t1IndexList):
    ...
    ks1 = fD.kSign(fF, fB, iFmax, iFmin, iBmax, iBmin)
    ...
    for t1Index in t1IndexList:                                                                     # Can be parallelised at this level
        ...
        R3sec = sF.secondPropagation(ij, ρij_t2, R_t2, P_t2, wt2, ks1, ks2, R3, t1Index)
        R3 = R3sec
